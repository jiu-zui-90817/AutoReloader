...
from fields import (
    TREE_ORDER, GROUP_LABELS, DEFAULT_ARMORS, DEFAULT_LOCOMOTORS,
    form_for_group,
)
    ...
    def load_section(self, section_id: str):
        ...
        for line in normalize_section_body(section_id, body).splitlines():
            ...
            if "=" in s:
                ...
                if k:
                    keys[k] = v
        form_config = form_for_group(self.current_group)
        self._loading = True
        self._clear_form()
